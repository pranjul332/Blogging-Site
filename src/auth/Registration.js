    ...
    return (
        <div className='relative flex flex-col items-center justify-center min-h-screen  bg-gray-300'>
            <form 
                ...
                <h1 className='text-3xl font-bold text-center text-gray-800 mb-4'>Registration</h1>
                ...
                <p className='text-center text-gray-600 mt-2'>
                    Already registered? 
                    <Link to='/login' className='text-blue-500 hover:underline ml-2'>Login here</Link>
                </p>
            </form>
